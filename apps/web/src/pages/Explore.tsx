...
export const Explore: FC = () => {
  ...
  const formatChange = (pct: number | undefined | null) => {
    if (pct == null) return <span style={{ color: '#67704f' }}>--</span>;
    const color = pct >= 0 ? '#c8ff00' : '#ff4d4d';
    const sign = pct >= 0 ? '+' : '';
  ...
  const tierBadge = (tier: string) => {
    const tierMap: Record<string, { color: string; bg: string; label: string }> = {
      bonded: { color: '#c8ff00', bg: 'rgba(200, 255, 0, 0.08)', label: 'Bonded' },
    ...
    <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {loading ? (
        ...
        <div style={{
          ...
          <div style={{ fontSize: 14, fontWeight: 500, color: '#a3ad8d' }}>
            {search ? 'No tokens found' : 'No tokens listed yet'}
          </div>
          <div style={{ fontSize: 12, color: '#67704f' }}>
          ...
          {displayTokens.map((token) => (
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <span style={{ fontSize: 16, fontWeight: 700, color: '#f0f4e4' }}>
                ...
                <div style={{ textAlign: 'right', flexShrink: 0 }}>
                  <div style={{
                    fontSize: 14, fontWeight: 600, color: '#f0f4e4',
              ...
              <div style={{
                ...
                <div>
                  <div style={{ fontSize: 10, color: '#67704f', marginBottom: 3, textTransform: 'uppercase', letterSpacing: '0.5px' }}>Volume</div>
                  <div style={{ fontSize: 13, fontWeight: 600, color: '#b3bd97', fontFamily: "'JetBrains Mono', monospace" }}>
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: 10, color: '#67704f', marginBottom: 3, textTransform: 'uppercase', letterSpacing: '0.5px' }}>Max Leverage</div>
                ...
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontSize: 10, color: '#67704f', marginBottom: 3, textTransform: 'uppercase', letterSpacing: '0.5px' }}>Fee</div>
                  <div style={{ fontSize: 13, fontWeight: 600, color: '#b3bd97', fontFamily: "'JetBrains Mono', monospace" }}>
