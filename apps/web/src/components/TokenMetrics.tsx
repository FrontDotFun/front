    ...
    <div className="token-metrics">
        ...
        <>
          <div className="token-metrics-item">
            ...
            <span className="token-metrics-value">
              <span style={{ color: '#3dff9e' }}>{buyRatio.toFixed(0)}%</span>
              <span style={{ color: '#3f3b26', margin: '0 2px' }}>/</span>
      ...
      {security && (
        <>
          <div className="token-metrics-item">
            ...
            <span className="token-metrics-value" style={{
              color: hasMintAuth ? '#ff4d4d' : '#3dff9e',
              fontSize: 9,
              fontWeight: 700,
            }}>
          ...
          <div className="token-metrics-item">
            ...
            <span className="token-metrics-value" style={{
              color: hasFreezeAuth ? '#ff4d4d' : '#3dff9e',
              fontSize: 9,
              fontWeight: 700,
            }}>
      ...
      <div className="token-metrics-item">
        ...
        <span
          ...
          style={{ color: priceChange >= 0 ? '#3dff9e' : '#ff4d4d' }}
        >
          {priceChange >= 0 ? '+' : ''}
